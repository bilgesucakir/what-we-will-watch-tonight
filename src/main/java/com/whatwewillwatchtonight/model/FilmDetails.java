 ...
 * @param tmdbId the exact TMDB movie id the film links to, or {@code null}; used
 *               to fetch the right poster instead of guessing from the title
 */
public record FilmDetails(Double rating, Integer length, Integer tmdbId) {
